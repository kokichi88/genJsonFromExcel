...
namespace Core.Skills.Modifiers {
	public class SuperArmorModifier : BaseModifier {
		private SuperArmorInfo info;
		...
		public SuperArmorModifier(ModifierInfo info, Entity casterEntity, Entity targetEntity,
